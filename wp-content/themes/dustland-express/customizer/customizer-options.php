...
function customizer_library_dustlandexpress_options() {
    ...
    $options['kra-upsell-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Change Site Layout to Boxed / Full Width<br />- Change Sidebar width<br />- Sticky Header<br />- Remove WooCommerce Cart<br />- WooCommerce Shop, Archive & Single to Left Sidebar<br />- Change Site Title Font & Sizing<br />- Change Site Tagline Sizing & Spacing', 'dustland-express' )
    );
    ...
    $options['kra-upsell-blog'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Set Blog List, Archives & Single pages to Full Width', 'dustland-express' )
    );
